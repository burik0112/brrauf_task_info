---
title: "Get Kanban Stages by Sprint ID tasks.api.scrum.kanban.getStages | Bitrix24 REST API and Marketplace Applications"
source: "https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/kanban/tasks-api-scrum-kanban-get-stages.html"
author:
published:
created: 2026-02-13
description:
...
| **Name**   `type` | **Description** |
| --- | --- |
| **id** \*   [`integer`](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/kanban/api-reference/data-types.html) | The identifier of the stage |
| **name** \*   [`string`](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/kanban/api-reference/data-types.html) | The name of the Kanban stage |
| **type**   [`string`](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/kanban/api-reference/data-types.html) | The type of the Kanban stage. Possible values: `NEW`, `WORK`, `FINISH` |
| **sort**   [`integer`](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/kanban/api-reference/data-types.html) | The sorting order |
| **color**   [`string`](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/kanban/api-reference/data-types.html) | The color of the Kanban stage |
