---
title: "Add Task to Scrum Kanban tasks.api.scrum.kanban.addTask | Bitrix24 REST API and Marketplace Applications"
source: "https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/kanban/tasks-api-scrum-kanban-add-task.html"
author:
published:
created: 2026-02-13
description:
...
| **taskId** \*   [`integer`](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/kanban/api-reference/data-types.html) | Identifier of the task. You can obtain the identifier using the method [tasks.task.list](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/kanban/api-reference/tasks/tasks-task-list.html) |
