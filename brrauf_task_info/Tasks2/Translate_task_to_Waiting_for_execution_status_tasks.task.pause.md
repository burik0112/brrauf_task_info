---
title: "Translate task to Waiting for execution status tasks.task.pause | Bitrix24 REST API and Marketplace Applications"
source: "https://apidocs.bitrix24.com/api-reference/tasks/tasks-task-pause.html"
author:
published:
created: 2026-02-13
description:
...
| `1048582` | Action on the task is not allowed | This error is returned in cases:  - the task with the specified `ID` does not exist - no access to the task - no rights to perform the action on the task |
...
- [Translate the task to In Progress status tasks.task.start](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/tasks/tasks-task-start.html)
