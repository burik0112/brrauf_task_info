---
title: "Disapprove Task tasks.task.disapprove | Bitrix24 REST API and Marketplace Applications"
source: "https://apidocs.bitrix24.com/api-reference/tasks/tasks-task-disapprove.html"
author:
published:
created: 2026-02-13
description:
...
You can check the permission to disapprove the assignee's work on the task using the [task access check method](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/tasks/tasks-task-get-access.html).
...
- [Approve Task tasks.task.approve](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/tasks/tasks-task-approve.html)
