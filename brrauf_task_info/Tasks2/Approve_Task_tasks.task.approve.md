---
title: "Approve Task tasks.task.approve | Bitrix24 REST API and Marketplace Applications"
source: "https://apidocs.bitrix24.com/api-reference/tasks/tasks-task-approve.html"
author:
published:
created: 2026-02-13
description:
...
You can check the permission to accept the work of the assignee on the task using the [check access to the task](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/tasks/tasks-task-get-access.html) method.
...
- [Disapprove Task tasks.task.disapprove](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/tasks/tasks-task-disapprove.html)
