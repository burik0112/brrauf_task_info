---
title: "Create a Scrum Kanban Stage tasks.api.scrum.kanban.addStage | Bitrix24 REST API and Marketplace Applications"
source: "https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/kanban/tasks-api-scrum-kanban-add-stage.html"
author:
published:
created: 2026-02-13
description:
...
| **sort**   [`integer`](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/kanban/api-reference/data-types.html) | Sort order. The field value must be a multiple of `100` |
