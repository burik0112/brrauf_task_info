...
source: "https://apidocs.bitrix24.com/api-reference/rest-v3/tasks/tasks-task-update.html"
author:
published:
created: 2026-02-13
description:
...
| **fields** \*   [`object`](https://apidocs.bitrix24.com/api-reference/rest-v3/tasks/api-reference/data-types.html) | Values of the task fields to be updated.   [Description of all task fields](https://apidocs.bitrix24.com/api-reference/rest-v3/tasks/api-reference/rest-v3/tasks/fields.html) |
...
| **Name**   `type` | **Description** |
| --- | --- |
| **result**   [`boolean`](https://apidocs.bitrix24.com/api-reference/rest-v3/tasks/api-reference/data-types.html) | Root element of the response.  Contains an object with the key `result` and the value `true` if the task was successfully updated |
...
| --- | --- | --- |
| `id`   `fields` | Required field `#FIELD#` is missing | Add the specified field to the request body |
