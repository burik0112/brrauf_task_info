---
title: "Disable Task Stopwatch tasks.task.stopwatch | Bitrix24 REST API and Marketplace Applications"
source: "https://apidocs.bitrix24.com/api-reference/tasks/tasks-task-stop-watch.html"
author:
published:
created: 2026-02-13
description:
...
| `1048584` | a:0:{} | Error returned in cases:  - the task with the specified `ID` does not exist - no access to the task |
...
- [Enable Task Watching tasks.task.startwatch](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/tasks/tasks-task-start-watch.html)