---
title: "Disable \"Mute\" mode tasks.task.unmute | Bitrix24 REST API and Marketplace Applications"
source: "https://apidocs.bitrix24.com/api-reference/tasks/tasks-task-unmute.html"
author:
published:
created: 2026-02-13
description:
...
| **Name**   `type` | **Description** |
| --- | --- |
| **result**   [`object`](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/data-types.html) | Object with response data.  Returns an empty array `"result":[]` if the user does not have access to the task or if the task with the specified `id` does not exist |
...
- [Enable "Mute" Mode tasks.task.mute](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/tasks/tasks-task-mute.html)