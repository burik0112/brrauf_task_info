---
title: "Delegate Task tasks.task.delegate | Bitrix24 REST API and Marketplace Applications"
source: "https://apidocs.bitrix24.com/api-reference/tasks/tasks-task-delegate.html"
author:
published:
created: 2026-02-13
description:
...
You can check the right to delegate a task using the [check access to the task](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/tasks/tasks-task-get-access.html) method.
...
| --- | --- |
| **taskId** \*   [`integer`](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/data-types.html) | Task identifier.  The task identifier can be obtained when [creating a new task](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/tasks/tasks-task-add.html) or by using the [getting the task list](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/tasks/tasks-task-list.html) method |
| **userId** \*   [`integer`](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/data-types.html) | Identifier of the user to whom the task is delegated.  The user identifier can be obtained using the [getting the user list](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/user/user-get.html) method |
...
- [Check Access to Task tasks.task.getaccess](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/tasks/tasks-task-get-access.html)