---
title: "Update backlog tasks.api.scrum.backlog.update | Bitrix24 REST API and Marketplace Applications"
source: "https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/backlog/tasks-api-scrum-backlog-update.html"
author:
published:
created: 2026-02-13
description:
...
| **Name**   `type` | **Description** |
| --- | --- |
| **groupId**   [`integer`](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/backlog/api-reference/data-types.html) | Identifier of the group to which the backlog belongs.  The group identifier can be obtained when creating a new group [sonet\_group.create](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/backlog/api-reference/sonet-group/sonet-group-create.html) or when retrieving a list of existing groups [socialnetwork-api-workgroup-list.md](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/backlog/api-reference/sonet-group/socialnetwork-api-workgroup-list.html) |
| **createdBy**   [`integer`](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/backlog/api-reference/data-types.html) | Identifier of the user who will create the backlog |
| **modifiedBy**   [`integer`](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/backlog/api-reference/data-types.html) | Identifier of the user who will modify the backlog |
...
| **Name**   `type` | **Description** |
| --- | --- |
| **id**   [`integer`](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/backlog/api-reference/data-types.html) | Backlog identifier |
| **groupId**   [`integer`](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/backlog/api-reference/data-types.html) | Identifier of the group for which the backlog was created |
| **createdBy**   [`integer`](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/backlog/api-reference/data-types.html) | Identifier of the user who created the backlog |
| **modifiedBy**   [`integer`](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/backlog/api-reference/data-types.html) | Identifier of the user who modified the backlog |
...
| --- | --- | --- |
| `100` | Could not find value for parameter | Required parameter `fields` not provided |
