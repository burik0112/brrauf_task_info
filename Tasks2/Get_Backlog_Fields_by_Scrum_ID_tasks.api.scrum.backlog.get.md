---
title: "Get Backlog Fields by Scrum ID tasks.api.scrum.backlog.get | Bitrix24 REST API and Marketplace Applications"
source: "https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/backlog/tasks-api-scrum-backlog-get.html"
author:
published:
created: 2026-02-13
description:
...
| **Name**   `type` | **Description** |
| --- | --- |
| **id**   [`integer`](https://apidocs.bitrix24.com/api-reference/sonet-group/scrum/backlog/api-reference/data-types.html) | Identifier of the backlog |
