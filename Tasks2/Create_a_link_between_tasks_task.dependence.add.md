---
title: "Create a link between tasks task.dependence.add | Bitrix24 REST API and Marketplace Applications"
source: "https://apidocs.bitrix24.com/api-reference/tasks/task-dependence-add.html"
author:
published:
created: 2026-02-13
description:
...
| --- | --- |
| **taskIdFrom** \*   [`integer`](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/data-types.html) | The identifier of the task from which the dependency is created |
| **taskIdTo** \*   [`integer`](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/data-types.html) | The identifier of the task for which the dependency is created |
| **linkType** \*   [`integer`](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/data-types.html) | Type of dependency:  - `0` — start-start link - `1` — start-finish link - `2` — finish-start link - `3` — finish-finish link |

The task identifier can be obtained when [creating a new task](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/tasks/tasks-task-add.html) or by using the [getting the list of tasks](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/tasks/tasks-task-list.html) method.
...
- [Delete the link between tasks task.dependence.delete](https://apidocs.bitrix24.com/api-reference/tasks/api-reference/tasks/task-dependence-delete.html)