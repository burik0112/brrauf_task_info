---
title: "Translate task to Completed status tasks.task.complete | Bitrix24 REST API and Marketplace Applications"
source: "https://apidocs.bitrix24.com/api-reference/tasks/tasks-task-complete.html"
author:
published:
created: 2026-02-13
description:
...
| `0` | Action on the task is not allowed | This error is returned in cases:  - the task with the specified `ID` does not exist - no access to the task - no permission to perform the action on the task |
