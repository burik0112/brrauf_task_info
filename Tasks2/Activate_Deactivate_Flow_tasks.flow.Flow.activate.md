---
title: "Activate/Deactivate Flow tasks.flow.Flow.activate | Bitrix24 REST API and Marketplace Applications"
source: "https://apidocs.bitrix24.com/api-reference/tasks/flow/tasks-flow-flow-activate.html"
author:
published:
created: 2026-02-13
description:
...
| **Name**   `type` | **Description** |
| --- | --- |
| **result**   [`boolean`](https://apidocs.bitrix24.com/api-reference/tasks/flow/api-reference/data-types.html) | Success of the operation |
